		...
		*/
		...
		public function generate_checkbox($dropdata, $name, $currentid = 0, $labels = null, $defaultval = '')
		{
			...
			foreach($dropdata as $dropdown)
			{
				...
				$returnvar .= '<li class="cat-item"><input class="postform cat-item" type="checkbox" name="'.SF_FPRE.$name.'[]" value="'.$dropdown->term_id.'"'.$checked.'> '.$dropdown->cat_name.'<label></label></li>';
